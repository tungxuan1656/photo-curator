...
- `docs/design-docs/decision-log.md` (DEC-038, DEC-039)
...
- State: done (PR #52 MERGED into main via `55cf176753be531fa64fbab68504e5487943d0e9`; feat-025 confirmed done; dep feat-023 done preserved; readiness record `docs/plans/feat-025.md` + DEC-039; no other feature touched)
...
- Evidence: `./init.sh` PASS (format, `swiftlint --strict`, Simulator build SUCCEEDED, SKIP [test] per no-test-targets policy); no test targets/`*Test*.swift`/frameworks.
- Blockers: none.
