...
- State: done (sole integration; DEC-037 exact-shortlist fix verified; deps feat-022 done + feat-024 done preserved; no other feature touched)
...
- Blockers: none.
- Next: review `tungxuan1656/feat-023-integration` (squash in a separate merge task); feat-025 selection remains user-gated; feat-023 must not be reactivated here.
