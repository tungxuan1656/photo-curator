...
require_source "$CANVAS_SOURCE" 'accessibilityLabel("Back")' "BACK-CONTROL"
require_source "$CANVAS_SOURCE" 'Text("\(position) / \(total)"' "POSITION-CONTROL"
require_source "$CANVAS_SOURCE" 'isSelected ? "In Album" : "Removed"' "SELECTION-CONTROL"
require_source "$CANVAS_SOURCE" 'accessibilityLabel("View Analysis")' "ANALYSIS-CONTROL"
require_source "$CANVAS_SOURCE" 'accessibilityLabel("Previous photo")' "PREVIOUS-CONTROL"
require_source "$CANVAS_SOURCE" 'accessibilityLabel("Next photo")' "NEXT-CONTROL"
require_source "$CANVAS_SOURCE" 'accessibilityLabel("Fit")' "FIT-CONTROL"
